...
function createOrEdit() {
    ...
    // Enviar para API
    fetch(`https://62712c596a36d4d62c22867c.mockapi.io/api/projects${screenType === 'edit' ? ('/' + params.id) : ''}`, {
...
function fillInputs(){
    if(screenType === 'edit') {
        fetch(`https://62712c596a36d4d62c22867c.mockapi.io/api/projects/${params.id}`)
        .then(response => response.json())
        .then(project =>{
